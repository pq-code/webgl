...
var geometry = new THREE.TorusGeometry(50, 2, 50); //创建一个立方体几何对象Geometry
...
var geometry1 = new THREE.TorusGeometry(40, 2, 40); //创建一个立方体几何对象Geometry
var material = new THREE.MeshPhongMaterial({
	color: 0x63B8FF
}); //材质对象Material
...
mesh1.position.y = 50;
mesh1.position.z = 0;
mesh1.castShadow = true;// 对象是否渲染到阴影贴图中
...
function render() {
	...
	mesh.rotateZ(0.001 * t);//旋转角速度0.001弧度每毫秒
  mesh1.rotateZ(-0.001 * t);//旋转角速度0.001弧度每毫秒
}
render();
